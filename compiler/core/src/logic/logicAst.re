...
and placeholderDeclaration = {id: string}
...
and placeholderEnumerationCase = {id: string}
...
and isEqualToBinaryOperator = {id: string}
and isNotEqualToBinaryOperator = {id: string}
and isLessThanBinaryOperator = {id: string}
and isGreaterThanBinaryOperator = {id: string}
and isLessThanOrEqualToBinaryOperator = {id: string}
and isGreaterThanOrEqualToBinaryOperator = {id: string}
and setEqualToBinaryOperator = {id: string}
and binaryOperator =
...
and functionCallArgumentFunctionCallArgument = {
  id: string,
  label: option(string),
  expression,
}
and functionCallArgument =
  | FunctionCallArgument(functionCallArgumentFunctionCallArgument)
...
and placeholderExpression = {id: string}
and expression =
...
and placeholderStatement = {id: string}
and statement =
  | Loop(loopStatement)
...
and typeIdentifierTypeAnnotation = {
  id: string,
  identifier,
  genericArguments: list(typeAnnotation),
}
...
module Decode = {
  ...
  and identifier: Js.Json.t => identifier =
    (json: Js.Json.t) =>
      Identifier({
        id: Json.Decode.field("id", Json.Decode.string, json),
        string: Json.Decode.field("string", Json.Decode.string, json),
        isPlaceholder:
          Json.Decode.field("isPlaceholder", Json.Decode.bool, json),
      })
  and declaration: Js.Json.t => declaration =
    (json: Js.Json.t) => {
      ...
      | "variable" =>
        Variable({
          ...
          annotation:
            Json.Decode.field(
              "annotation",
              Json.Decode.optional(typeAnnotation),
              data,
            ),
          initializer_:
            Json.Decode.field(
              "initializer",
              Json.Decode.optional(expression),
              data,
            ),
        })
      | "function" =>
        Function({
          ...
          parameters:
            Json.Decode.field("parameters", list(functionParameter), data),
      ...
      | "namespace" =>
        Namespace({
          ...
          name: Json.Decode.field("name", pattern, data),
          declarations:
            Json.Decode.field("declarations", list(declaration), data),
        })
      | "placeholder" =>
  ...
  and binaryOperator: Js.Json.t => binaryOperator =
    (json: Js.Json.t) => {
      let rec case = Json.Decode.field("type", Json.Decode.string, json);
      let rec data = Json.Decode.field("data", x => x, json);
      switch (case) {
      ...
      | "isNotEqualTo" =>
        IsNotEqualTo({id: Json.Decode.field("id", Json.Decode.string, data)})
      | "isLessThan" =>
  ...
  and functionCallArgument: Js.Json.t => functionCallArgument =
    (json: Js.Json.t) =>
      FunctionCallArgument({
        ...
        expression: Json.Decode.field("expression", expression, json),
      })
  and expression: Js.Json.t => expression =
    (json: Js.Json.t) => {
      let rec case = Json.Decode.field("type", Json.Decode.string, json);
      let rec data = Json.Decode.field("data", x => x, json);
      switch (case) {
      ...
      | "functionCallExpression" =>
        FunctionCallExpression({
          ...
          arguments:
            Json.Decode.field("arguments", list(functionCallArgument), data),
        })
      | "literalExpression" =>
        LiteralExpression({
          id: Json.Decode.field("id", Json.Decode.string, data),
  ...
  and syntaxNode: Js.Json.t => syntaxNode =
    (json: Js.Json.t) => {
      let rec case = Json.Decode.field("type", Json.Decode.string, json);
      let rec data = Json.Decode.field("data", x => x, json);
      switch (case) {
    ...
    (json: Js.Json.t) => {
      ...
      | "functionType" =>
        FunctionType({
          ...
          returnType: Json.Decode.field("returnType", typeAnnotation, data),
          argumentTypes:
            Json.Decode.field("argumentTypes", list(typeAnnotation), data),
        })
      | "placeholder" =>
        Placeholder({id: Json.Decode.field("id", Json.Decode.string, data)})
      | _ =>
  ...
  and topLevelParameters: Js.Json.t => topLevelParameters =
    (json: Js.Json.t) =>
      TopLevelParameters({
        id: Json.Decode.field("id", Json.Decode.string, json),
        parameters:
          Json.Decode.field("parameters", list(functionParameter), json),
      })
