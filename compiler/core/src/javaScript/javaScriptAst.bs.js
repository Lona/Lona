...
function variableDeclaration(param_0) {
  return /* VariableDeclaration */Block.__(12, [param_0]);
}

function assignmentExpression(param_0) {
  return /* AssignmentExpression */Block.__(13, [param_0]);
}

function binaryExpression(param_0) {
  return /* BinaryExpression */Block.__(14, [param_0]);
}

function ifStatement(param_0) {
  return /* IfStatement */Block.__(15, [param_0]);
}

function arrayLiteral(param_0) {
  return /* ArrayLiteral */Block.__(16, [param_0]);
}

function objectLiteral(param_0) {
  return /* ObjectLiteral */Block.__(17, [param_0]);
}

function property(param_0) {
  return /* Property */Block.__(18, [param_0]);
}

function exportDefaultDeclaration(param_0) {
  return /* ExportDefaultDeclaration */Block.__(19, [param_0]);
}

function block(param_0) {
  return /* Block */Block.__(20, [param_0]);
}

function program(param_0) {
  return /* Program */Block.__(21, [param_0]);
}
...
function map(f, node) {
  if (typeof node === "number") {
    ...
    switch (node.tag | 0) {
      ...
      case 12 : 
          return Curry._1(f, /* VariableDeclaration */Block.__(12, [map(f, node[0])]));
      case 13 : 
          var o$6 = node[0];
          return Curry._1(f, /* AssignmentExpression */Block.__(13, [{
                          left: map(f, o$6.left),
                          right: map(f, o$6.right)
                        }]));
      case 14 : 
          var o$7 = node[0];
          return Curry._1(f, /* BinaryExpression */Block.__(14, [{
                          left: map(f, o$7.left),
      ...
      case 15 : 
          var o$8 = node[0];
          return Curry._1(f, /* IfStatement */Block.__(15, [{
                          test: map(f, o$8.test),
      ...
      case 16 : 
          return Curry._1(f, /* ArrayLiteral */Block.__(16, [List.map((function (param) {
                                return map(f, param);
                              }), node[0])]));
      case 17 : 
          return Curry._1(f, /* ObjectLiteral */Block.__(17, [List.map((function (param) {
                                return map(f, param);
                              }), node[0])]));
      case 18 : 
          var o$9 = node[0];
          return Curry._1(f, /* Property */Block.__(18, [{
                          key: map(f, o$9.key),
                          value: map(f, o$9.value)
                        }]));
      case 19 : 
          return Curry._1(f, /* ExportDefaultDeclaration */Block.__(19, [map(f, node[0])]));
      case 20 : 
          return Curry._1(f, /* Block */Block.__(20, [List.map((function (param) {
                                return map(f, param);
                              }), node[0])]));
      case 21 : 
          return Curry._1(f, /* Program */Block.__(21, [List.map((function (param) {
                                return map(f, param);
                              }), node[0])]));
      case 22 : 
          var o$10 = node[0];
          return Curry._1(f, /* LineEndComment */Block.__(22, [{
