...
function toSwiftAST(options, colors, textStyles, rootLayer, logicRootNode) {
  ...
  var logicValueToSwiftAST = function (x) {
    ...
    if (typeof initialValue === "number" || initialValue.tag !== 8) {
      return initialValue;
    } else {
    ...
    if (typeof logicRootNode === "number") {
      ...
      switch (logicRootNode.tag | 0) {
        case 0 : 
            ...
            var exit = 0;
            var exit$1 = 0;
            if (typeof left === "number" || left.tag) {
              exit$1 = 2;
            } else {
              var match = left[0];
              if (typeof match === "number" || match.tag || !(match[0] && operator === "==")) {
                exit$1 = 2;
              } else {
                var condition = right;
            ...
            if (exit$1 === 2) {
              if (operator === "==" && !(typeof right === "number" || right.tag)) {
                var match$1 = right[0];
            ...
            return /* StatementListHelper */Block.__(25, [/* :: */[
                        ...
                        /* :: */[
                          /* IfStatement */Block.__(15, [{
                                condition: /* LiteralExpression */Block.__(0, [/* Boolean */Block.__(0, [true])]),
        ...
        case 2 : 
            ...
            if (typeof match$2 === "number" || match$2.tag !== 8) {
              ...
              var name = match$2[0];
              var exit$5 = 0;
              if (typeof match$3 === "number" || !(match$3.tag === 1 && name.endsWith("borderColor") && options[/* framework */0] === /* UIKit */0)) {
                exit$5 = 4;
              } else {
        ...
        case 5 : 
            ...
            if (left$1.tag || typeof match$4 === "number" || !(match$4.tag === 10 && !(typeof match$5 === "number" || match$5.tag !== 2))) {
              return /* Empty */0;
            } else {
              var a = match$4[0];
              return /* VariableDeclaration */Block.__(10, [{
