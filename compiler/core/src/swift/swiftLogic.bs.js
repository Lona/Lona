          ...
          case "layers" : 
              if (tail) {
                ...
                if (second === rootLayer[/* name */1]) {
                  return /* SwiftIdentifier */Block.__(6, [List.fold_left((function (a, b) {
              ...
              break;
          case "parameters" : 
              return /* SwiftIdentifier */Block.__(6, [List.hd(tail)]);
          default:
            return /* SwiftIdentifier */Block.__(6, [head]);
        }
      } else {
        return /* SwiftIdentifier */Block.__(6, ["BadIdentifier"]);
      }
    ...
    if (typeof logicRootNode === "number") {
      ...
      switch (logicRootNode.tag | 0) {
        case 0 : 
            ...
            break;
        case 1 : 
            return /* StatementListHelper */Block.__(19, [/* :: */[
                        /* LineComment */Block.__(16, ["TODO: IfExists"]),
                        /* :: */[
        ...
        case 2 : 
            ...
            if (typeof match$2 === "number") {
              exit$4 = 3;
            } else if (match$2.tag === 6) {
              var name = match$2[0];
              if (name.endsWith("visible")) {
                return /* BinaryExpression */Block.__(2, [{
                            left: /* SwiftIdentifier */Block.__(6, [name.replace("visible", "isHidden")]),
                            operator: "=",
              ...
              if (typeof match$3 === "number") {
                ...
                if (name$1.endsWith("visible")) {
                  return /* BinaryExpression */Block.__(2, [{
                              ...
                              operator: "=",
                              right: /* SwiftIdentifier */Block.__(6, [name$1.replace("visible", "isHidden")])
                            }]);
                } else {
                  exit$3 = 2;
                }
        ...
        case 5 : 
            ...
            break;
        case 6 : 
            return /* StatementListHelper */Block.__(19, [List.map(inner, logicRootNode[0])]);
