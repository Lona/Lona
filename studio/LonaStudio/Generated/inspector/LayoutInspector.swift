...
extension LayoutInspector {
  public indirect enum Direction: Codable & Equatable {
    case horizontal
    case vertical
...
extension LayoutInspector {
  public indirect enum HorizontalAlignment: String, Codable & Equatable {
    case left
    case center
    case right
  }
...
extension LayoutInspector {
  public indirect enum VerticalAlignment: String, Codable & Equatable {
    case top
    case middle
    case bottom
  }
