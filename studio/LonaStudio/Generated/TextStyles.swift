...
class TextStyles {
  ...
  public static let large = TextStyle(size: 15, color: Colors.black)
  public static let regular = TextStyle(size: 13, color: Colors.black)
  public static let small = TextStyle(size: 11, color: Colors.black)
