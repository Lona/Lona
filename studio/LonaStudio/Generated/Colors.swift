...
public enum Colors {
  ...
  public static let headerBackground = #colorLiteral(red: 0.960784313725, green: 0.960784313725, blue: 0.960784313725, alpha: 1) // #F5F5F5 - Should be rgba(216,216,216,0.25)
