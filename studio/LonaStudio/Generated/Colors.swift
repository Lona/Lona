...
public enum Colors {
  ...
  public static let systemSelection10 = #colorLiteral(red: 0.0156862745098, green: 0.388235294118, blue: 0.882352941176, alpha: 0.1) // RGBA(4,99,225,0.1) - MacOS system selection color, 10% opacity
  public static let systemSelection30 = #colorLiteral(red: 0.0156862745098, green: 0.388235294118, blue: 0.882352941176, alpha: 0.3) // RGBA(4,99,225,0.3) - MacOS system selection color, 30% opacity
