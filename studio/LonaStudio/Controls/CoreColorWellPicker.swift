// This file was originally generated from a .component, but then had to be modified
// so that its `colorValue` parameter is converted from an optional to a non-optional
...
public class CoreColorWellPicker: NSBox {
    ...
    private func update() {
        colorWellPickerView.colorValue = colorValue ?? Color.black
