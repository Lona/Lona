...
A number specifying the version of the specs of the colors. The `$version` number is required. This is currently `2`.

### `themes`

The default theme is the first item of the array, if any. The `themes` array is optional.
...
Each color-profile has the following attributes:
...
| `case`    | "color" or "themed" or "group" or "ref" | Yes      | The type of the color. Defines how the value should look like.                                                                                                                                                                    |
| `value`   | Depends on `case`                       | Yes      | An object representing the color. See [Color's Value](#colors-value) for more information about it.                                                                                                                               |
...
An object representing the color. The `value` of the color depends on its `case`.
