...
export default class TextStylesTest extends React.Component {
  render() {
    return (
      <View>
        <Text1>{'Text goes here'}</Text1>
        <Text2>{'Text goes here'}</Text2>
        <Text3>{'Text goes here'}</Text3>
        <View3>
          <Text4>{'Text goes here'}</Text4>
        </View3>
        <View1>
          <Text5>{'Text goes here'}</Text5>
        </View1>
        <View2>
          <Text6>
            {
        ...
        <Text7>{'Text goes here'}</Text7>
        <Text8>{'Text goes here'}</Text8>
        <Text9>{'Text goes here'}</Text9>
      </View>
    )
  }
}
