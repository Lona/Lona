    ...
    return (
      <View>
        <View1>
          ...
          <View2 />
          <Text>{'Welcome to Lona Studio'}</Text>
          <Text1>{'Centered - Width: Fit'}</Text1>
          <Text2>{'Left aligned - Width: Fill'}</Text2>
          <Text3>{'Right aligned - Width: Fill'}</Text3>
          <Text4>{'Centered - Width: 80'}</Text4>
        </View1>
        <View3>
          <Text5>{'Left aligned text, Fit w/ secondary centering'}</Text5>
        </View3>
        <View4>
          <Text6>{'Left aligned text, Fixed w/ secondary centering'}</Text6>
        </View4>
        <View5>
          <Text7>{'Centered text, Fit parent no centering'}</Text7>
        </View5>
        <View6>
          <Text8>{'Centered text, Fixed parent no centering'}</Text8>
        </View6>
        <RightAlignmentContainer>
          <Text9>{'Fit Text'}</Text9>
          <Text10>{'Fill and center aligned text'}</Text10>
