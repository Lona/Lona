    ...
    return (
      <View style={styles.view}>
        <View style={styles.view1}>
          ...
          <Text style={styles.text1}>{'Centered - Width: Fit'}</Text>
          <Text style={styles.text2}>{'Left aligned - Width: Fill'}</Text>
          <Text style={styles.text3}>{'Right aligned - Width: Fill'}</Text>
          <Text style={styles.text4}>{'Centered - Width: 80'}</Text>
        </View>
        ...
        <View style={styles.rightAlignmentContainer}>
          <Text style={styles.text9}>{'Fit Text'}</Text>
          <Text style={styles.text10}>{'Fill and center aligned text'}</Text>
          <Image
            style={styles.image1}
            source={require('../assets/icon_128x128.png')}
          />
