  ...
  render() {
    return (
      <View style={styles.view}>
        <Text style={styles.text1}>{'Text goes here'}</Text>
        <Text style={styles.text2}>{'Text goes here'}</Text>
        <Text style={styles.text3}>{'Text goes here'}</Text>
        <View style={styles.view3}>
          <Text style={styles.text4}>{'Text goes here'}</Text>
        </View>
        <View style={styles.view1}>
          <Text style={styles.text5}>{'Text goes here'}</Text>
        </View>
        ...
        <Text style={styles.text7}>{'Text goes here'}</Text>
        <Text style={styles.text8}>{'Text goes here'}</Text>
        <Text style={styles.text9}>{'Text goes here'}</Text>
      </View>
    )
  }
}
