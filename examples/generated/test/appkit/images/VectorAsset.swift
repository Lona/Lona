...
private class ToggleVector: NSView {
  ...
  override func draw(_ dirtyRect: CGRect) {
    ...
    let path0_0 = NSBezierPath()
    path0_0.move(to: transform(point: CGPoint(x: 12, y: 0.5)))
    path0_0.line(to: transform(point: CGPoint(x: 36, y: 0.5)))
    path0_0.curve(
    ...
    path0_0.line(to: transform(point: CGPoint(x: 47.5, y: 12)))
    path0_0.curve(
    ...
    path0_0.line(to: transform(point: CGPoint(x: 12, y: 23.5)))
    path0_0.curve(
    ...
    path0_0.line(to: transform(point: CGPoint(x: 0.5, y: 12)))
    path0_0.curve(
    ...
    path0_0.lineCapStyle = .buttLineCapStyle
    path0_0.stroke()
    let path0_1 = NSBezierPath()
    path0_1.move(to: transform(point: CGPoint(x: 12, y: 2)))
    path0_1.line(to: transform(point: CGPoint(x: 12, y: 2)))
    path0_1.curve(
    ...
    path0_1.line(to: transform(point: CGPoint(x: 22, y: 12)))
    path0_1.curve(
    ...
    path0_1.line(to: transform(point: CGPoint(x: 12, y: 22)))
    path0_1.curve(
    ...
    path0_1.line(to: transform(point: CGPoint(x: 2, y: 12)))
    path0_1.curve(
...
private class Toggle_verticalVector: NSView {
  ...
  override func draw(_ dirtyRect: CGRect) {
    ...
    let path2_0 = NSBezierPath()
    path2_0.move(to: transform(point: CGPoint(x: 12, y: 0.5)))
    path2_0.line(to: transform(point: CGPoint(x: 12, y: 0.5)))
    path2_0.curve(
    ...
    path2_0.line(to: transform(point: CGPoint(x: 23.5, y: 36)))
    path2_0.curve(
    ...
    path2_0.line(to: transform(point: CGPoint(x: 12, y: 47.5)))
    path2_0.curve(
    ...
    path2_0.line(to: transform(point: CGPoint(x: 0.5, y: 12)))
    path2_0.curve(
      to: transform(point: CGPoint(x: 12, y: 0.5)),
      controlPoint1: transform(point: CGPoint(x: 0.5, y: 5.64872537694)),
      controlPoint2: transform(point: CGPoint(x: 5.64872537694, y: 0.5)))
    ...
    path2_0.lineCapStyle = .buttLineCapStyle
    path2_0.stroke()
    let path2_1 = NSBezierPath()
    path2_1.move(to: transform(point: CGPoint(x: 12, y: 2)))
    path2_1.line(to: transform(point: CGPoint(x: 12, y: 2)))
    path2_1.curve(
      to: transform(point: CGPoint(x: 22, y: 12)),
      controlPoint1: transform(point: CGPoint(x: 17.5228474983, y: 2)),
      controlPoint2: transform(point: CGPoint(x: 22, y: 6.47715250169)))
    path2_1.line(to: transform(point: CGPoint(x: 22, y: 12)))
    path2_1.curve(
      to: transform(point: CGPoint(x: 12, y: 22)),
      controlPoint1: transform(point: CGPoint(x: 22, y: 17.5228474983)),
      controlPoint2: transform(point: CGPoint(x: 17.5228474983, y: 22)))
    path2_1.line(to: transform(point: CGPoint(x: 12, y: 22)))
    path2_1.curve(
      to: transform(point: CGPoint(x: 2, y: 12)),
      controlPoint1: transform(point: CGPoint(x: 6.47715250169, y: 22)),
      controlPoint2: transform(point: CGPoint(x: 2, y: 17.5228474983)))
    path2_1.line(to: transform(point: CGPoint(x: 2, y: 12)))
    path2_1.curve(
      to: transform(point: CGPoint(x: 12, y: 2)),
      controlPoint1: transform(point: CGPoint(x: 2, y: 6.47715250169)),
      controlPoint2: transform(point: CGPoint(x: 6.47715250169, y: 2)))
...
private class Check_circleVector: NSView {
  ...
  override func draw(_ dirtyRect: CGRect) {
    ...
    path0_0.line(to: transform(point: CGPoint(x: 12, y: 0)))
    path0_0.curve(
    ...
    path0_0.line(to: transform(point: CGPoint(x: 24, y: 12)))
    path0_0.curve(
    ...
    path0_0.line(to: transform(point: CGPoint(x: 12, y: 24)))
    path0_0.curve(
    ...
    path0_0.line(to: transform(point: CGPoint(x: 0, y: 12)))
    path0_0.curve(
    ...
    path0_1.line(to: transform(point: CGPoint(x: 9.75, y: 15.85)))
    path0_1.line(to: transform(point: CGPoint(x: 17.25, y: 8.35)))
    #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1).setStroke()
    path0_1.lineWidth = 2 * scale
    path0_1.lineCapStyle = .roundLineCapStyle
    path0_1.stroke()
  }
}
