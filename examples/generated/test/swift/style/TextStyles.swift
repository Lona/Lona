...
public class TextStyles: UIView {
  ...
  private func setUpViews() {
    ...
    text1View.text = "Text goes here"
    text2View.text = "Text goes here"
    text3View.text = "Text goes here"
    text4View.text = "Text goes here"
    text5View.text = "Text goes here"
    text6View.text = "Text goes here"
    text7View.text = "Text goes here"
    text8View.text = "Text goes here"
    text9View.text = "Text goes here"
  }
